...
export default function BrandActiveCampaignsPage() {
    ...
    /**
     * Fetch campaigns for the logged‑in brand and normalise the response shape.
     * The API now returns `{ meta, campaigns: [...] }`, so we need to read
     * `response.campaigns` instead of treating the root object as an array.
     */
...
interface TableViewProps {
    ...
    onToggle: (campaign: Campaign) => Promise<void>;
        ...
        <div className="p-[1.5px] rounded-lg bg-gradient-to-r shadow">
            <div className="overflow-x-auto bg-white rounded-[0.5rem]">
                <table className="w-full text-sm text-gray-600">
                    ...
                    >
                        <tr>
                            {["Campaign", "Budget", "Status", "Timeline", "Influencers Working", "Actions"].map((h) => (
