...
export default function PrivacyPolicyAdmin() {
  ...
  useEffect(() => {
    post<Policy>('/policy/getlist', { policyType: 'Returns Policy' })
      .then(res => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Returns Policy Admin</h1>
      ...
      <div className="mb-6">
        <label className="block mb-1 font-medium">Returns Policy Content</label>
        <Textarea
          rows={15}
          value={policyText}
